    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (token) {
                ...
                const imageUrls = typeof inputs.images === 'string' ? inputs.images.split(',').map(url => url.trim()) : inputs.images;
                ...
                const availableSlots = typeof inputs.availableSlots === 'string' ? inputs.availableSlots.split(',').map(timeslot => timeslot.trim()) : inputs.availableSlots;
